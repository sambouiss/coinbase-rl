...
if __name__ == "main":
    ...
    products = ["AMP-USD"]
    env = Env.Enviroment(startTime,endTime,api,products,session_length=session_length)
        ...
        try:
            ...
            while True:
                ...
                if step%20== 0:
                    ...
                    print("cumulative reward: {} pos pnl: {} mean loss actor: {}  mean loss critic: {}".format(
                        rewards_sum,
                        env.pos_pnl,
                        np.mean(loss_actor),
                        np.mean(loss_critic),
